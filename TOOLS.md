...
**Related**: [Standards & Certifications](resources/RESEARCH.md) | [Tools & Approaches](resources/APPROACHES.md) | [ITPM](concepts/project_management/itpm.md)
...
| Extension | Purpose |
|-----------|---------|
| Azure Repos | Git integration with Azure DevOps |
| Bicep | Azure IaC authoring |
...
| Tool | Focus | Link |
|------|-------|------|
| **SQL Server Management Studio (SSMS)** | SQL Server administration | [learn.microsoft.com/ssms](https://learn.microsoft.com/sql/ssms/) |
...
| Tool | Focus | Link |
|------|-------|------|
| **Azure Storage Explorer** | Blob/Table/Queue/File management | [azure.microsoft.com/storage-explorer](https://azure.microsoft.com/features/storage-explorer/) |
| **Power BI Desktop** | Data visualization | [powerbi.microsoft.com/desktop](https://powerbi.microsoft.com/desktop/) |
| **dbt** | SQL transformations | [getdbt.com](https://www.getdbt.com/) |
| **Great Expectations** | Data validation | [greatexpectations.io](https://greatexpectations.io/) |
...
| Tool | Focus | Link |
|------|-------|------|
| **Docker Desktop** | Container development | [docker.com/products/docker-desktop](https://www.docker.com/products/docker-desktop/) |
...
| Tool | Focus | Link |
|------|-------|------|
| **diagrams.net (Draw.io)** | Free diagramming | [diagrams.net](https://www.diagrams.net/) |
...
| **Microsoft Planner** | Task management | [microsoft.com/planner](https://www.microsoft.com/microsoft-365/business/task-management-software) |
...
| **Notion** | Docs & wikis | [notion.so](https://www.notion.so/) |
| **Obsidian** | Personal knowledge base | [obsidian.md](https://obsidian.md/) |
| **Typora** | Markdown editor | [typora.io](https://typora.io/) |

---

## Quick Reference — Essential Stack

| Category | Recommended Tools |
|----------|-------------------|
| **Editor** | VS Code + GitLens + Bicep extensions |
...
> **Note**: For cloud services and platforms (Azure Data Factory, Databricks, Fabric), see architecture documentation in [concepts/cloud/](concepts/cloud/).
